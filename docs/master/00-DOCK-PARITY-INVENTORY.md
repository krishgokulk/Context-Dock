...
| D4 | System command scope | ❌ | checked on the app 2026-09-24: → on a system-command row **runs it** — → on "Sleep" put the Mac to sleep. Dock steps in; this is a safety bug |
...
| F2 | ↑/↓ keys switch Global ↔ Context ↔ Media when not in a list | 🟡 | PR #79. checked on the app 2026-09-24: ↓ at rest goes Global → app ✅; ↑ in the app scope opens the app's action list instead of going up to Global ❌ |
...
C2, F1 ✅; A4, B3, C1, F2 🟡; C4–C7, C9, D4 ❌. Still ❓, not tried: B2, B4, C11, C12, D7, D13,
...
**D4 is a safety bug**: → on a system-command row runs it.

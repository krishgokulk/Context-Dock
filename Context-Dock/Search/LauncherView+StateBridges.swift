...
extension LauncherView {
    ...
    var showShortcutSheet: Bool {
        get { launcherViewModel.showShortcutSheet }
        nonmutating set { launcherViewModel.showShortcutSheet = newValue }
    }

    var shortcutSheetFocusedCommandID: String? {
        get { launcherViewModel.shortcutSheetFocusedCommandID }
        nonmutating set { launcherViewModel.shortcutSheetFocusedCommandID = newValue }
    }
    ...
    var shortcutSheetSearchQuery: String {
        get { launcherViewModel.shortcutSheetSearchQuery }
        nonmutating set { launcherViewModel.shortcutSheetSearchQuery = newValue }
    }
    ...
    var shortcutSheetChatMessages: [AIChatMessage] {
        get { launcherViewModel.shortcutSheetChatMessages }
        nonmutating set { launcherViewModel.shortcutSheetChatMessages = newValue }
    }

    var shortcutSheetChatLoading: Bool {
        get { launcherViewModel.shortcutSheetChatLoading }
        nonmutating set { launcherViewModel.shortcutSheetChatLoading = newValue }
    }

    var shortcutSheetSourcePID: pid_t {
        get { launcherViewModel.shortcutSheetSourcePID }
        nonmutating set { launcherViewModel.shortcutSheetSourcePID = newValue }
    }

    var shortcutSheetAppName: String {
        get { launcherViewModel.shortcutSheetAppName }
        nonmutating set { launcherViewModel.shortcutSheetAppName = newValue }
    }

    var shortcutSheetSelectionSnapshot: SelectionContextSnapshot? {
        get { launcherViewModel.shortcutSheetSelectionSnapshot }
        nonmutating set { launcherViewModel.shortcutSheetSelectionSnapshot = newValue }
    }

    var shortcutSheetSelectionExpanded: Bool {
        get { launcherViewModel.shortcutSheetSelectionExpanded }
        nonmutating set { launcherViewModel.shortcutSheetSelectionExpanded = newValue }
    }
